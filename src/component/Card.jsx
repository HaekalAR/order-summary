            ...
            <div className="bg-[white] rounded-xl overflow-hidden md:w-[24em] max-h-[90%] w-80 ">
                ...
                <div className="py-10 px-7 flex flex-col gap-4">
                    <div className="text-center flex flex-col gap-2">
                        <h2 className="text-[--dark-blue] font-[900] md:text-2xl text-xl">Order Summary</h2>
                        <p className="font-[500] md:text-[15px] text-[13px] text-[--desaturated-blue]">You can now listen to millions of songs, audiobooks, and podcasts, on any device anywhere you like!</p>
                    </div>
                    <div className="flex items-center justify-between bg-[--very-pale-blue] rounded-xl p-4">
                        <div className="flex gap-4">
                            ...
                            <div>
                                <h3 className="font-[700] md:text-base text-sm text-[--dark-blue]">Annual Plan</h3>
                                <p className="md:text-[15px] text-[13px] text-[--desaturated-blue] font-[500]">$59.99/year</p>
                            </div>
                        </div>
                        <div>
                            <a href="#" className="font-[700] md:text-md text-sm text-[--bright-blue] hover:text-[#988bf9] transition-all duration-300">Change</a>
                        </div>
                    </div>
